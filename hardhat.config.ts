...
const config: HardhatUserConfig = {
    ...
    networks: {
        ...
        goerli: {
            url: process.env["GOERLI_RPC"] || "https://eth-goerli.api.onfinality.io/public",
            accounts:
    ...
    namedAccounts: {
        ...
        protocolTreasury: {
            ...
            avalanche: process.env["AVALANCHE_PROTOCOL_TREASURY_ADDRESS"] || "0x0",
        ...
        wbtc: {
            ...
            goerli: "0x6ce27497a64fffb5517aa4aee908b1e7eb63b9ff",
        },
        usdc: {
